...
#define SAURIA_CFG_CON_ACT_REPS_MASK 0x3fff
...
#define SAURIA_CFG_CON_WEI_REPS_2_MASK 0xfff
...
#define SAURIA_CFG_CON_THRES_OFFSET 12
...
#define SAURIA_CFG_CON_RES_MASK_OFFSET 14
...
#define SAURIA_CFG_CON_APPR_MASK_1_MASK 0x3f  //APPR_MASK is splitted between 2 registers
#define SAURIA_CFG_CON_APPR_MASK_1_OFFSET 26
...
#define SAURIA_CFG_CON_APPR_MASK_2_MASK 0x3  
...
//--------------------------------------------------------
#define SAURIA_CFG_CON_SRAM_DEEPSLEEP_BIT 2
#define SAURIA_CFG_CON_SRAM_POWERGATE_BIT 3
...
#define SAURIA_CFG_OUT_NCONTEXTS_MASK 0x3fff
...
#define SAURIA_CFG_OUT_CXLIM_MASK 0x3fff
#define SAURIA_CFG_OUT_CXLIM_OFFSET 14
#define SAURIA_CFG_OUT_CXLIM_FIELD \
  ((bitfield_field32_t) { .mask = SAURIA_CFG_OUT_CXLIM_MASK, .index = SAURIA_CFG_OUT_CXLIM_OFFSET })
#define SAURIA_CFG_OUT_CXSTEP_1_MASK 0xf   //CXSTEP is splitted between 2 registers
#define SAURIA_CFG_OUT_CXSTEP_1_OFFSET 28
...
#define SAURIA_CFG_OUT_CXSTEP_2_MASK 0x3ff
...
#define SAURIA_CFG_OUT_CKLIM_MASK 0x3fff
#define SAURIA_CFG_OUT_CKLIM_OFFSET 10
#define SAURIA_CFG_OUT_CKLIM_FIELD \
  ((bitfield_field32_t) { .mask = SAURIA_CFG_OUT_CKLIM_MASK, .index = SAURIA_CFG_OUT_CKLIM_OFFSET })
#define SAURIA_CFG_OUT_CKSTEP_1_MASK 0xff   //OUT_CKSTEP is splitted between 2 registers
#define SAURIA_CFG_OUT_CKSTEP_1_OFFSET 24
...
#define SAURIA_CFG_OUT_CKSTEP_2_MASK 0x3f
...
#define SAURIA_CFG_OUT_TIL_CYLIM_MASK 0x3fff
#define SAURIA_CFG_OUT_TIL_CYLIM_OFFSET 6
...
#define SAURIA_CFG_OUT_TIL_CYSTEP_1_MASK 0xfff   //TIL_CYSTEP is splitted between 2 registers
#define SAURIA_CFG_OUT_TIL_CYSTEP_1_OFFSET 20
...
#define SAURIA_CFG_OUT_TIL_CYSTEP_2_MASK 0x3
...
#define SAURIA_CFG_OUT_TIL_CKLIM_MASK 0x3fff
#define SAURIA_CFG_OUT_TIL_CKLIM_OFFSET 2
...
#define SAURIA_CFG_OUT_TIL_CKSTEP_MASK 0x3fff
#define SAURIA_CFG_OUT_TIL_CKSTEP_OFFSET 16
#define SAURIA_CFG_OUT_TIL_CKSTEP_FIELD \
  ((bitfield_field32_t) { .mask = SAURIA_CFG_OUT_TIL_CKSTEP_MASK, .index = SAURIA_CFG_OUT_TIL_CKSTEP_OFFSET })
#define SAURIA_CFG_OUT_INACTIVE_COLS_1_MASK 0x3   //INACTIVE_COLS is splitted between 2 registers
#define SAURIA_CFG_OUT_INACTIVE_COLS_1_OFFSET 30
#define SAURIA_CFG_OUT_INACTIVE_COLS_1_FIELD \
  ((bitfield_field32_t) { .mask = SAURIA_CFG_OUT_INACTIVE_COLS_1_MASK, .index = SAURIA_CFG_OUT_INACTIVE_COLS_1_OFFSET })
//-------------------------------------------------------- 

#define SAURIA_CFG_OUT_IDX4_OFFSET 0x810
#define SAURIA_CFG_OUT_INACTIVE_COLS_2_MASK 0x3f
#define SAURIA_CFG_OUT_INACTIVE_COLS_2_OFFSET 0
#define SAURIA_CFG_OUT_INACTIVE_COLS_2_FIELD \
  ((bitfield_field32_t) { .mask = SAURIA_CFG_OUT_INACTIVE_COLS_2_MASK, .index = SAURIA_CFG_OUT_INACTIVE_COLS_2_OFFSET })  
#define SAURIA_CFG_OUT_PRELOAD_EN_BIT 6
...
#define SAURIA_SRAMA_OFFSET 0x00000
...
#define SAURIA_SRAMB_OFFSET 0x10000
...
#define SAURIA_SRAMC_OFFSET 0x20000
